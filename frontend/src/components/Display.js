...
import { HOLDING_COLUMNS } from './columns'
    ...
    return (
        <div className="Display">
            <div className="Display__left">
                <Menu />
                <h5 style={{ paddingTop: 1, textAlign: 'center' }}>Click on <a href='/signal' style={{ color: '#011', textDecoration: 0 }}>CHECK NEW SIGNALS </a>  to see rocommended trades</h5>
                <h4 style={{ paddingTop: 1, textAlign: 'center' }} >ARK ETF Tracker</h4>
                <h5 style={{ textAlign: 'center' }}>Click on a row to see detailed trades history</h5>
                <Tradetable trades={trades} table_columns={columns} holdingData={holdingData} tradeData={tradeData} />
            </div>
